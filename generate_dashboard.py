...
<body class="theme--night">
    <div class="container">
        ...
        <div class="refresh-notice">
            💡 Refresh: <code>recall --dashboard</code> or <code>python3 generate_dashboard.py</code>
        </div>
        ...
        <footer>
            ...
            Built with love by <a href="https://ant312.com" target="_blank" rel="noopener noreferrer">ANT</a>
        </footer>
    </div>
