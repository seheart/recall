...
class MigrationManager:
    ...
    def _register_migrations(self):
        ...
        self.migrations.append(
            Migration(version=1, name="add_project_tags_table", up=migration_001_up)
        )
        ...
        self.migrations.append(Migration(version=2, name="add_search_indexes", up=migration_002_up))
    ...
    def rollback_migration(self, target_version: int) -> bool:
        ...
        migrations_to_rollback = [
            m for m in reversed(self.migrations) if current_version >= m.version > target_version
        ]
